...
const rechercheSoiree = (props) => {
    ...
    const RedirectionSoiree=()=>{
        props.navigation.navigate("Recherche covoit")
    }
    const retourMap = () => {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.container3}>
                <TouchableOpacity style={styles.connexionAvec} onPress={() => RedirectionSoiree()}>
                    <Text style={styles.choix2}>Covoiturage</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.connexionAvec}>
                    <Text style={styles.choix1}>Soirées</Text>
                </TouchableOpacity>               
            </View>
            <SafeAreaView>
                <FlatList
...
export default rechercheSoiree;